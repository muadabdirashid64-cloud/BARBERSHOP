...
import { LayoutDashboard, LogOut, Menu, Calendar, Users } from 'lucide-react';
...
const navItems: { to: string; label: TranslationKey; icon: typeof LayoutDashboard; color: string }[] = [
  { to: '/barber', label: 'dashboard', icon: LayoutDashboard, color: 'bg-blue-500' },
  { to: '/barber/appointments', label: 'appointments', icon: Calendar, color: 'bg-gold-500' },
  { to: '/barber/customers', label: 'customers', icon: Users, color: 'bg-green-500' },
];
    ...
    <div className="flex h-full flex-col bg-ink-950">
      <div className="flex items-center gap-3 px-6 py-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">{t('barberPanel')}</p>
        </div>
      </div>
      ...
      <div className="border-t border-white/5 p-4">
        <div className="flex items-center gap-3 rounded-xl bg-white/5 p-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-gray-400">{t('barber')}</p>
          </div>
